...
Begin VB.Form frm_Mnt_ClaCre_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_118.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_118.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   585
            Left            =   2430
            Picture         =   "GesCtb_frm_118.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   1830
            Picture         =   "GesCtb_frm_118.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_118.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_118.frx":0F3E
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_118.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frm_Mnt_ClaCre_01"
...
Private Sub cmd_Borrar_Click()
   ...
   'Instrucción SQL
   g_str_Parame = "DELETE FROM CTB_TIPCLA WHERE "
   g_str_Parame = g_str_Parame & "TIPCLA_TIPCRE = '" & moddat_g_str_CodIte & "' AND "
   g_str_Parame = g_str_Parame & "TIPCLA_CODIGO = '" & moddat_g_str_Codigo & "' "
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "TIPCLA_TIPCRE = '" & moddat_g_str_Codigo & "' "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = g_rst_Princi!TIPCLA_CODIGO
      
      grd_Listad.Col = 1
      grd_Listad.Text = Trim(g_rst_Princi!TIPCLA_DESCRI)
      
      grd_Listad.Col = 2
      grd_Listad.Text = CStr(g_rst_Princi!TIPCLA_DIAINI)
      
      grd_Listad.Col = 3
      grd_Listad.Text = CStr(g_rst_Princi!TIPCLA_DIAFIN)
