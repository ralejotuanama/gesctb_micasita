...
Begin VB.Form frm_Mnt_ClaGar_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_120.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_120.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   11
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_120.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   10
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_120.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_120.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "frm_Mnt_ClaGar_01"
...
Private Sub cmd_Borrar_Click()
   ...
   'Instrucción SQL
   g_str_Parame = "DELETE FROM CTB_CLAGAR WHERE "
   g_str_Parame = g_str_Parame & "CLAGAR_CODIGO = '" & moddat_g_str_CodGrp & "' "
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = "SELECT * FROM CTB_CLAGAR ORDER BY CLAGAR_CODIGO ASC"
   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 3) Then
       Exit Sub
   End If
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = Trim(g_rst_Princi!CLAGAR_CODIGO)
      
      grd_Listad.Col = 1
      grd_Listad.Text = Trim(g_rst_Princi!CLAGAR_DESCRI)
