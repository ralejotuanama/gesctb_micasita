...
Begin VB.Form frm_Mnt_ClaGar_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin Threed.SSPanel SSPanel11 
            ...
            _ExtentY        =   847
            _StockProps     =   15
            Caption         =   "Mantenimiento de Clases de Garantías"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_121.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_121.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_121.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frm_Mnt_ClaGar_02"
...
Private Sub cmd_Grabar_Click()
   ...
   If Len(Trim(txt_Prefij.Text)) = 0 Then
      MsgBox "Debe ingresar el Prefijo.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(txt_Prefij)
      Exit Sub
   End If
   
   If moddat_g_int_FlgGrb = 1 Then
      g_str_Parame = "SELECT * FROM CTB_CLAGAR WHERE CLAGAR_CODIGO = '" & txt_Codigo.Text & "' "
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         MsgBox "El Código de Clase de Garantía ya ha sido registrado.", vbExclamation, modgen_g_str_NomPlt
         Call gs_SetFocus(txt_Codigo)
         Exit Sub
      End If
...
Private Sub Form_Load()
   ...
   If moddat_g_int_FlgGrb = 2 Then
      g_str_Parame = "SELECT * FROM CTB_CLAGAR WHERE CLAGAR_CODIGO = '" & moddat_g_str_CodGrp & "' "
      If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 3) Then
          Exit Sub
      End If
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         txt_Descri.Text = Trim(g_rst_Princi!CLAGAR_DESCRI)
         txt_Prefij.Text = Trim(g_rst_Princi!CLAGAR_PREFIJ & "")
      End If
...
Private Sub txt_Prefij_GotFocus()
   Call gs_SelecTodo(txt_Prefij)
End Sub
