   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin Threed.SSPanel SSPanel11 
            ...
            _ExtentY        =   847
            _StockProps     =   15
            Caption         =   "Mantenimiento de Clasificación por Tipo de Crédito"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
...
Private Sub cmd_Grabar_Click()
   If Len(Trim(txt_Codigo.Text)) = 0 Then
      MsgBox "Debe ingresar el Código de Garantía.", vbExclamation, modgen_g_str_NomPlt
   ...
   If moddat_g_int_FlgGrb = 1 Then
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         MsgBox "El Código de Garantía ya ha sido registrado.", vbExclamation, modgen_g_str_NomPlt
         Call gs_SetFocus(txt_Codigo)
         Exit Sub
      End If
