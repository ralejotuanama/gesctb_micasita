...
Begin VB.Form frm_Mnt_NatCre_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin Threed.SSPanel SSPanel11 
            ...
            _ExtentY        =   847
            _StockProps     =   15
            Caption         =   "Mantenimiento de Naturaleza de Créditos"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_126.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_126.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_126.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_126.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_126.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frm_Mnt_NatCre_01"
...
Private Sub cmd_Borrar_Click()
   ...
   'Instrucción SQL
   g_str_Parame = "DELETE FROM CTB_NATCRE WHERE "
   g_str_Parame = g_str_Parame & "NATCRE_CODIGO = '" & moddat_g_str_CodGrp & "' "
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = "SELECT * FROM CTB_NATCRE ORDER BY NATCRE_CODIGO ASC"
   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 3) Then
       Exit Sub
   End If
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = Trim(g_rst_Princi!NATCRE_CODIGO)
      
      grd_Listad.Col = 1
      grd_Listad.Text = Trim(g_rst_Princi!NATCRE_DESCRI)
