...
Begin VB.Form frm_Mnt_ClaCta_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_140.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_140.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_140.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_140.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_140.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Mnt_ClaCta_01"
...
Private Sub cmd_Borrar_Click()
   ...
   'Instrucción SQL
   g_str_Parame = "DELETE FROM CTB_CLACTA WHERE "
   g_str_Parame = g_str_Parame & "CLACTA_CODCLA = '" & moddat_g_str_CodGrp & "' "
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = "SELECT * FROM CTB_CLACTA ORDER BY CLACTA_CODCLA ASC"
   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 3) Then
       Exit Sub
   End If
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = Trim(g_rst_Princi!CLACTA_CODCLA)
      
      grd_Listad.Col = 1
      grd_Listad.Text = Trim(g_rst_Princi!CLACTA_DESCRI)
