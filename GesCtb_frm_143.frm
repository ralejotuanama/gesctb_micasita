...
Begin VB.Form frm_Mnt_TipMon_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_143.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6750
            Picture         =   "GesCtb_frm_143.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_143.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "frm_Mnt_TipMon_02"
...
Private Sub cmd_Grabar_Click()
   ...
   If moddat_g_int_FlgGrb = 1 Then
      g_str_Parame = "SELECT * FROM CTB_TIPMON WHERE TIPMON_CODIGO = '" & txt_Codigo.Text & "' "
...
Private Sub Form_Load()
   ...
   If moddat_g_int_FlgGrb = 2 Then
      g_str_Parame = "SELECT * FROM CTB_TIPMON WHERE TIPMON_CODIGO = '" & moddat_g_str_CodGrp & "' "
      If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 3) Then
          Exit Sub
      End If
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         txt_Descri.Text = Trim(g_rst_Princi!TIPMON_DESCRI)
      End If
