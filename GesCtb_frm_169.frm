...
Begin VB.Form frm_Mat_CtaPry_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         EndProperty
         BevelOuter      =   1
         Begin Threed.SSPanel pnl_PryHip 
            Height          =   315
            Left            =   1770
            TabIndex        =   10
            Top             =   60
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_169.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_169.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   8580
            Picture         =   "GesCtb_frm_169.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_Mat_CtaPry_02"
...
Private Sub cmd_Grabar_Click()
   ...
   If moddat_g_int_FlgGrb = 1 Then
      ...
      g_str_Parame = g_str_Parame & "CTAPRY_TIPMON = " & CStr(cmb_TipMon.ItemData(cmb_TipMon.ListIndex)) & " AND "
      g_str_Parame = g_str_Parame & "CTAPRY_CONCTB = '" & l_arr_ConCtb(cmb_ConCtb.ListIndex + 1).Genera_Codigo & "' AND "
...
Private Sub Form_Load()
   ...
   pnl_PryHip.Caption = moddat_g_str_DesGrp
   ...
   If moddat_g_int_FlgGrb = 2 Then
      g_str_Parame = "SELECT * FROM CTB_CTAPRY WHERE CTAPRY_CODPRY = '" & moddat_g_str_CodGrp & "' AND "
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         Call gs_BuscarCombo_Item(cmb_TipMon, g_rst_Princi!CTAPRY_TIPMON)
         
         cmb_ConCtb.ListIndex = gf_Busca_Arregl(l_arr_ConCtb, Trim(g_rst_Princi!CTAPRY_CONCTB)) - 1
         cmb_CtaCtb.ListIndex = gf_Busca_Arregl(l_arr_CtaCtb, Trim(g_rst_Princi!CTAPRY_CTACTB)) - 1
...
Private Sub fs_Inicio()
   ...
   Call moddat_gs_Carga_ConceptoCtb(l_arr_ConCtb, cmb_ConCtb, 4)
End Sub
