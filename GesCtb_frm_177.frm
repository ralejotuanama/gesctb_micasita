...
Begin VB.Form frm_Asi_GasCie_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin Threed.SSPanel SSPanel5 
            ...
            _ExtentY        =   476
            _StockProps     =   15
            Caption         =   "Gastos de Cierre (Cred. Hipot.)"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_177.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_177.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7230
            Picture         =   "GesCtb_frm_177.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.Label Label2 
            Caption         =   "(*) Según Fecha de Movimiento Operativo"
            Height          =   255
            Left            =   2970
            TabIndex        =   15
            Top             =   60
   ...
   End
End
Attribute VB_Name = "frm_Asi_GasCie_01"
...
Dim l_str_IniOpe     As String
Dim l_str_FinOpe     As String

Private Sub cmb_Empres_Click()
   If cmb_Empres.ListIndex > -1 Then
      Screen.MousePointer = 11
      
      pnl_Period.Caption = moddat_gf_ConsultaPerMesActivo(l_arr_Empres(cmb_Empres.ListIndex + 1).Genera_Codigo, 1, l_str_IniOpe, l_str_FinOpe, modctb_int_PerMes, modctb_int_PerAno)
...
Private Sub cmd_Proces_Click()
   ...
   If CDate(ipp_FecIni.Text) < CDate(l_str_IniOpe) Or CDate(ipp_FecFin.Text) > CDate(l_str_FinOpe) Then
      MsgBox "La Fecha de Inicio y de Fin se encuentran fuera del rango del Período Operativo (" & l_str_IniOpe & " - " & l_str_FinOpe & ").", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(ipp_FecIni)
      Exit Sub
   End If
...
Private Sub fs_Limpia()
   ...
   ipp_FecIni.Text = l_str_IniOpe
   ipp_FecFin.Text = l_str_FinOpe
End Sub
