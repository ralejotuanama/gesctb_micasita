   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   873
            _StockProps     =   15
            Caption         =   "Registros de Tarjeta Crédito Corporativo"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
          ...
          If grd_Listad.TextMatrix(r_int_Contad, 10) = "NO" Then
             If grd_Listad.TextMatrix(r_int_Contad, 11) = "X" Then
                ...
                If Not gf_EjecutaSQL(g_str_Parame, g_rst_Genera, 3) Then
                   MsgBox "La rendición " & grd_Listad.TextMatrix(r_int_Contad, 0) & " no se puede procesar.", vbExclamation, modgen_g_str_NomPlt
                   Screen.MousePointer = 0
                   Exit Sub
                End If
                ...
                If (g_rst_Genera!RESUL = 2) Then 'saldo negativos
                    MsgBox "La rendición " & grd_Listad.TextMatrix(r_int_Contad, 0) & " tiene saldo negativo, no se proceso." & vbCrLf & _
                            "solo se procesaron:" & Trim(r_str_CajPrc), vbExclamation, modgen_g_str_NomPlt
                    Screen.MousePointer = 0
                    Exit Sub
                ElseIf (g_rst_Genera!RESUL = 3) Then 'no tiene detalle
                    MsgBox "La rendición " & grd_Listad.TextMatrix(r_int_Contad, 0) & " no tiene detalle, no se proceso." & vbCrLf & _
                           "solo se procesaron:" & Trim(r_str_CajPrc), vbExclamation, modgen_g_str_NomPlt
                    Screen.MousePointer = 0
                    Exit Sub
                ElseIf (g_rst_Genera!RESUL = 4) Then 'moneda diferente
                    MsgBox "La rendición " & grd_Listad.TextMatrix(r_int_Contad, 0) & " tiene monedas distintas, no se proceso." & vbCrLf & _
                           "solo se procesaron:" & Trim(r_str_CajPrc), vbExclamation, modgen_g_str_NomPlt
                    Screen.MousePointer = 0
                    Exit Sub
                End If
...
Private Sub fs_Inicia()
   ...
   grd_Listad.ColAlignment(2) = flexAlignCenterCenter 'año
