...
Begin VB.Form frm_Pro_CtbGas_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel2 
            ...
            _ExtentY        =   661
            _StockProps     =   15
            Caption         =   "Contabilización de Gastos de Cierre de Créditos Hipotecarios"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_804.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_804.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_804.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7260
            Picture         =   "GesCtb_frm_804.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frm_Pro_CtbGas_01"
...
Dim r_rst_PerMes        As ADODB.Recordset
   ...
   If MsgBox("¿Está seguro de contabilizar los gastos de cierre?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
   ...
   'Proceso de Amortizacion de Gastos de Cierre de Creditos Hipotecarios
   Call modprc_ctbp1013(l_arr_Empres(cmb_Empres.ListIndex + 1).Genera_Codigo, p_FecIni, p_FecFin, r_str_PerIni, r_str_PerFin, r_str_PerMes, r_str_PerAno, r_str_CtbIni, r_str_CtbFin, pnl_BarPro)
...
Private Sub cmd_ExpExc_Click()
   ...
   If MsgBox("¿Está seguro de exportar el proceso de gastos de cierre?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
...
Dim r_rst_PerMes        As ADODB.Recordset
   ...
   g_str_Parame = g_str_Parame & "       A.COD_USR AS CODUSR, B.ITEM AS CODREG, B.CNTA_CTBL AS CTACTB, B.FECHA_CNTBL AS FECCTB, "
   g_str_Parame = g_str_Parame & "       B.DET_GLOSA AS DESGLO, B.FLAG_DEBHAB AS DEBHAB, B.IMP_MOVSOL AS MOVSOL, B.IMP_MOVDOL AS MOVDOL, B.CTB_FECAUX AS FECAUX "
   ...
   g_str_Parame = g_str_Parame & "   AND B.NRO_DOCREF3 = '3' "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 9) = Left(Trim(g_rst_Princi!DESGLO), 12)
...
Dim r_int_FlgCam     As Integer
   ...
   r_str_CadEje = "SELECT CAJMOV_SUCMOV, CAJMOV_USUMOV, CAJMOV_FECMOV, CAJMOV_FECDEP, CAJMOV_NUMMOV, CAJMOV_NUMOPE, CAJMOV_ITFIMP, " & _
                  "       CAJMOV_MONPAG, CAJMOV_IMPTOT, CAJMOV_IMPPAG, CAJMOV_CODBAN, CAJMOV_NUMCTA " & _
                  "  FROM OPE_CAJMOV " & _
                  " WHERE CAJMOV_TIPMOV = 1101 AND CAJMOV_CTBFLG = 0 " & _
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      g_rst_Princi.MoveFirst
      Do While Not g_rst_Princi.EOF
         If CDate(gf_FormatoFecha(g_rst_Princi!CAJMOV_FECMOV)) > CDate(p_CtbFin) Then
            r_str_FecAsi = p_CtbFin
         Else
            r_str_FecAsi = gf_FormatoFecha(CStr(g_rst_Princi!CAJMOV_FECMOV))
         End If
         
         r_dbl_TipSbs = fs_ObtieneTipCamDia_3(2, CStr(g_rst_Princi!CAJMOV_MONPAG), Format(r_str_FecAsi, "yyyymmdd"), 1)
         r_dbl_TipSun = fs_ObtieneTipCamDia_2(2, CStr(g_rst_Princi!CAJMOV_MONPAG), CStr(g_rst_Princi!CAJMOV_FECDEP), 2)
         
         If r_dbl_TipSbs = 0 Then
            r_int_FlgCam = 1
            MsgBox "Falta ingresar tipo de cambio SBS para la fecha: " & r_str_FecAsi, vbExclamation, modgen_g_str_NomPlt
         End If
         If r_dbl_TipSun = 0 Then
            r_int_FlgCam = 1
            MsgBox "Falta ingresar tipo de cambio SUNAT para la fecha: " & CStr(g_rst_Princi!CAJMOV_FECDEP), vbExclamation, modgen_g_str_NomPlt
         End If
