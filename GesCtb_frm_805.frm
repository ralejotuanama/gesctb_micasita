...
Begin VB.Form frm_Pro_CtbCuo_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel2 
            ...
            _ExtentY        =   661
            _StockProps     =   15
            Caption         =   "Contabilización de Pago de Cuotas de Créditos Hipotecarios"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.24
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_805.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7260
            Picture         =   "GesCtb_frm_805.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   45
            Picture         =   "GesCtb_frm_805.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   660
            Picture         =   "GesCtb_frm_805.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frm_Pro_CtbCuo_01"
...
Dim r_rst_PerMes        As ADODB.Recordset
   ...
   'Validacion del Ingreso de Tipo de Cambio SBS o SUNAT
   ...
   If MsgBox("¿Está seguro de contabilizar las Amortizaciones?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Screen.MousePointer = 0
      Exit Sub
   End If
   ...
   'Proceso de Amortizacion de Cuotas de Creditos Hipotecarios
   Call modprc_ctbp1005(l_arr_Empres(cmb_Empres.ListIndex + 1).Genera_Codigo, p_FecIni, p_FecFin, r_str_PerIni, r_str_PerFin, r_str_PerMes, r_str_PerAno, r_str_CtbIni, r_str_CtbFin, pnl_BarPro)
...
Dim r_int_FlgCam     As Integer
   ...
   r_str_CadEje = "SELECT CAJMOV_SUCMOV, CAJMOV_USUMOV, CAJMOV_FECMOV, CAJMOV_FECDEP, CAJMOV_NUMMOV, CAJMOV_NUMOPE, CAJMOV_ITFIMP, " & _
                  "       CAJMOV_MONPAG, CAJMOV_IMPTOT, CAJMOV_CODBAN, CAJMOV_NUMCTA, CAJMOV_IMPPAG " & _
                  "  FROM OPE_CAJMOV WHERE CAJMOV_TIPMOV = 1102 AND CAJMOV_CTBFLG = 0 " & _
