...
Begin VB.Form frm_RptCtb_07 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_807.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_HojTra 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_807.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6150
            Picture         =   "GesCtb_frm_807.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_807.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Imprimir Reporte"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_807.frx":0EA4
            Style           =   1  'Graphical
            TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frm_RptCtb_07"
...
Private Sub cmd_HojTra_Click()
   ...
   'r_str_PerMes = cmb_PerMes.ItemData(cmb_PerMes.ListIndex)
   'r_str_PerAno = ipp_PerAno.Text
   
   'Call fs_GenExc2(r_str_PerMes, r_str_PerAno)
...
Private Sub fs_GenExc(ByVal p_FecIni As String, ByVal p_FecFin As String)
   ...
   Dim r_dbl_DetGar()      As modprc_g_tpo_DetGar
   ...
   g_str_Parame = "SELECT HIPCIE_NUMOPE, HIPCIE_CLAPRV, HIPCIE_PRVGEN, HIPCIE_PRVESP, HIPCIE_PRVCIC, HIPCIE_SITCRE, HIPCIE_CLAPRV, HIPCIE_SALCAP, HIPCIE_SALCON, HIPCIE_TIPCAM, HIPMAE_GARLIN, HIPMAE_CODPRD, HIPCIE_TIPGAR FROM CRE_HIPCIE H, CRE_HIPMAE M WHERE "
