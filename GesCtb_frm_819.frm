...
Begin VB.Form frm_Pro_CtbAho_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_819.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_819.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_819.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7260
            Picture         =   "GesCtb_frm_819.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frm_Pro_CtbAho_01"
...
Dim r_rst_PerMes        As ADODB.Recordset
   ...
   If MsgBox("¿Está seguro de ejecutar la contabilización del Plan de Ahorro?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
   ...
   Call modprc_ctbp1015(l_arr_Empres(cmb_Empres.ListIndex + 1).Genera_Codigo, p_FecIni, p_FecFin, r_str_PerIni, r_str_PerFin, r_str_PerMes, r_str_PerAno, r_str_CtbIni, r_str_CtbFin, pnl_BarPro)
...
Private Sub cmd_ExpExc_Click()
   ...
   If MsgBox("¿Está seguro de Exportar el proceso de Amortizaciones?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
...
Dim r_int_FlgCam     As Integer
   ...
   r_str_CadEje = "SELECT CAJMOV_SUCMOV, CAJMOV_USUMOV, CAJMOV_FECMOV, CAJMOV_FECDEP, CAJMOV_NUMMOV, CAJMOV_NUMOPE, CAJMOV_ITFIMP, " & _
                  ...
                  "  FROM OPE_CAJMOV WHERE CAJMOV_TIPMOV = 1101 AND CAJMOV_CTBFLG = 0 " & _
