...
Begin VB.Form frm_Pro_CtbCof_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_821.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   40
            Picture         =   "GesCtb_frm_821.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   660
            Picture         =   "GesCtb_frm_821.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Detail 
            Height          =   585
            Left            =   1890
            Picture         =   "GesCtb_frm_821.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   5
            ToolTipText     =   "Detalle"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   2500
            Picture         =   "GesCtb_frm_821.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   1280
            Picture         =   "GesCtb_frm_821.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   12720
            Picture         =   "GesCtb_frm_821.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin Threed.SSPanel SSPanel22 
         ...
         Begin Threed.SSPanel pnl_Tit_NumOpe 
            ...
            Outline         =   -1  'True
         End
         Begin Threed.SSPanel pnl_Tit_DesCli 
            Height          =   285
            Left            =   9630
            TabIndex        =   20
            Top             =   60
            ...
            Outline         =   -1  'True
         End
         Begin Threed.SSPanel pnl_Tit_ComCof 
            Height          =   285
            Left            =   7890
            TabIndex        =   21
            Top             =   60
   ...
   End
End
Attribute VB_Name = "frm_Pro_CtbCof_01"
...
Dim r_int_ConSel        As Integer
   ...
   Screen.MousePointer = 11
   Call fs_GeneraAsiento_DesCofide
   Call fs_BuscaDatos
   Screen.MousePointer = 0
...
Dim r_dbl_SumPre     As Double
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT NUM_CARTA, FEC_DESEMBOLSO, COUNT(*) AS NRO_OPERACIONES, SUM(DES_COFIDE) AS DES_COFIDE, SUM(DES_CLIENTE) AS DES_CLIENTE "
   ...
   g_str_Parame = g_str_Parame & "               EVACOF_MTODES      AS DES_COFIDE, "
   g_str_Parame = g_str_Parame & "               HIPMAE_TOTPRE      As DES_CLIENTE "
   ...
   g_str_Parame = g_str_Parame & "         WHERE ((EVACOF_FLGCNT = 0) OR (EVACOF_FLGCNT IS NULL)) "
   ...
   If (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      MsgBox "No se encontraron nuevos numeros de carta cofide.", vbInformation, modgen_g_str_NomPlt
      g_rst_Princi.Close
   ...
   Do While Not g_rst_Princi.EOF
      If Not IsNull(g_rst_Princi!NUM_CARTA) Then
         ...
         grd_Listad.Col = 3
         grd_Listad.Text = Format(g_rst_Princi!DES_COFIDE, "###,###,##0.00")
         
         grd_Listad.Col = 4
         grd_Listad.Text = Format(g_rst_Princi!DES_CLIENTE * 0.25 / 100, "###,##0.00")
...
Private Sub fs_GeneraAsiento_DesCofide()
...
Dim r_dbl_DesCof        As Double
Dim r_dbl_DesCli        As Double
Dim r_dbl_MtoDol        As Double
Dim r_dbl_ComCofAcu     As Double
Dim r_dbl_DesCofAcu     As Double
Dim r_dbl_DesCliAcu     As Double
   ...
   For r_int_Contad = 0 To grd_Listad.Rows - 1
      ...
      If grd_Listad.TextMatrix(r_int_Contad, 6) = "X" Then
         '*************************************************
         'GENERACION DE ASIENTOS CONTABLES POR CARTA COFIDE
         '*************************************************
         ...
         'Consulta operaciones asociadas al numero de carta cofide
         g_str_Parame = " "
         ...
         If (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
            MsgBox "No se encontraron operaciones de la carta cofide " & Trim(r_str_NumCar) & ".", vbExclamation, modgen_g_str_NomPlt
            g_rst_Princi.Close
            Set g_rst_Princi = Nothing
            Exit Sub
         End If
         ...
         g_rst_Princi.MoveFirst
         Do While Not g_rst_Princi.EOF
            If IsNull(g_rst_Princi!MONTO_PRESTAMO) Or g_rst_Princi!NRO_OPERACION = "-" Then
         ...
         Call modprc_fs_Inserta_CabAsi(r_arr_LogPro, r_str_Origen, l_int_PerAno, l_int_PerMes, r_int_NumLib, r_int_NumAsi, Format(1, "000"), r_dbl_TipSbs, r_str_TipNot, "DESEMBOLSO COFIDE - CARTA " & Trim(r_str_NumCar) & " - " & r_str_NroOpe & " OPER.", r_str_FecDes, "1")
         ...
         Do While Not g_rst_Princi.EOF
            ...
            r_dbl_ComCof = Format((CDbl(g_rst_Princi!MONTO_PRESTAMO) * 0.25 / 100), "###,##0.00")
            r_dbl_DesCof = Format(CDbl(g_rst_Princi!MONTO_DESEMBOLSO), "###,###,##0.00")
            r_dbl_DesCli = Format(CDbl(g_rst_Princi!MONTO_PRESTAMO), "###,###,##0.00")
            r_dbl_MtoDol = Format(0, "###,###,##0.00") 'r_dbl_MtoDol = Format(CDbl(r_dbl_DesCli / r_dbl_TipSbs), "###,###,##0.00")
            r_str_CtaHab = "261202010103"
            
            'Insertar en DETALLE
            Call modprc_fs_Inserta_DetAsi_PagVar(r_arr_LogPro, r_str_Origen, l_int_PerAno, l_int_PerMes, r_int_NumLib, r_int_NumAsi, r_int_NumIte, r_str_CtaHab, CDate(r_str_FecDes), "DESEMBOLSO COFIDE - " & CStr(r_str_NumOpe) & " - " & Trim(r_str_NumCar), "H", r_dbl_DesCli, r_dbl_MtoDol, 1, CDate(r_str_FecDes))
            
            r_dbl_ComCofAcu = r_dbl_ComCofAcu + Format((CDbl(g_rst_Princi!MONTO_PRESTAMO) * 0.25 / 100), "###,##0.00")
            r_dbl_DesCofAcu = r_dbl_DesCofAcu + Format(CDbl(g_rst_Princi!MONTO_DESEMBOLSO), "###,###,##0.00")
            r_dbl_DesCliAcu = r_dbl_DesCliAcu + Format(CDbl(g_rst_Princi!MONTO_PRESTAMO), "###,###,##0.00")
         ...
         'Cuadra la comision por desembolso
         If Format(CDbl(r_dbl_ComCofAcu + r_dbl_DesCofAcu), "###,###,##0.00") <> Format(CDbl(r_dbl_DesCliAcu), "###,###,##0.00") Then
            r_dbl_ComCofAcu = r_dbl_DesCliAcu - r_dbl_DesCofAcu
         End If
         
         'Insertar en DETALLE (suma comisiones)
         r_str_CtaDeb = "421201010110"
         r_dbl_MtoDol = Format(0, "###,###,##0.00") 'r_dbl_MtoDol = Format(CDbl(r_dbl_ComCofAcu / r_dbl_TipSbs), "###,###,##0.00")
         Call modprc_fs_Inserta_DetAsi_PagVar(r_arr_LogPro, r_str_Origen, l_int_PerAno, l_int_PerMes, r_int_NumLib, r_int_NumAsi, r_int_NumIte, r_str_CtaDeb, CDate(r_str_FecDes), "COMISION DESEMBOLSO COFIDE - " & Trim(r_str_NumCar), "D", r_dbl_ComCofAcu, r_dbl_MtoDol, 1, CDate(r_str_FecDes))
         
         'Insertar en DETALLE (suma desembolsos cofide)
         r_str_CtaDeb = "111301060102"
         r_int_NumIte = r_int_NumIte + 1
         r_dbl_MtoDol = Format(0, "###,###,##0.00") 'r_dbl_MtoDol = Format(CDbl(r_dbl_DesCofAcu / r_dbl_TipSbs), "###,###,##0.00")
         Call modprc_fs_Inserta_DetAsi_PagVar(r_arr_LogPro, r_str_Origen, l_int_PerAno, l_int_PerMes, r_int_NumLib, r_int_NumAsi, r_int_NumIte, r_str_CtaDeb, CDate(r_str_FecDes), "DESEMBOLSO COFIDE - " & Trim(r_str_NumCar), "D", r_dbl_DesCofAcu, r_dbl_MtoDol, 1, CDate(r_str_FecDes))
         
         'Actualiza flag de contabilizacion para las operacion con el numero de carta
         g_str_Parame = ""
         g_str_Parame = g_str_Parame & "UPDATE TRA_EVACOF "
         g_str_Parame = g_str_Parame & "   SET EVACOF_FLGCNT = 1 "
...
Dim r_int_NumFil        As Integer
   ...
   With r_obj_Excel.ActiveSheet
      .Cells(2, 2) = "CONTABILIZACION DE DESEMBOLSOS COFIDE"
      ...
      .Cells(5, 2) = "NRO. CARTA COFIDE"
      .Cells(5, 3) = "FECHA DESEMBOLSO"
      .Cells(5, 4) = "NRO. OPERACIONES"
      .Cells(5, 5) = "DESEMBOLSO COFIDE"
      .Cells(5, 6) = "COMISION COFIDE"
      .Cells(5, 7) = "DESEMBOLSO CLIENTE"
