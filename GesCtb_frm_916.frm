...
Begin VB.Form frm_Pro_CtbIntCof_01 
   ...
   Begin Threed.SSPanel SSPanel6 
      ...
      Begin Threed.SSPanel SSPanel7 
         ...
         _ExtentY        =   556
         _StockProps     =   15
         Caption         =   "Contabilización de Interés por pagar a COFIDE"
         ForeColor       =   32768
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.26
...
Dim r_int_NumFil        As Integer
   ...
   With r_obj_Excel.ActiveSheet
      .Cells(2, 2) = "CONTABILIZACIÓN DE ASIENTOS DEL PBP"
      ...
      For r_int_Contad = 0 To grd_Listad.Rows - 1
         ...
         If r_int_Contad = grd_Listad.Rows - 1 Then
            ...
            .Cells(r_int_NumFil + 3, 3) = CStr(grd_Listad.TextMatrix(r_int_Contad, 1))             'PROVISIÓN INTERÉS COFIDE
         Else
            .Cells(r_int_NumFil + 3, 2) = "'" & CStr(grd_Listad.TextMatrix(r_int_NumFil - 3, 0))   'PRODUCTO
            .Cells(r_int_NumFil + 3, 3) = CStr(grd_Listad.TextMatrix(r_int_NumFil - 3, 1))         'PROVISIÓN INTERÉS COFIDE
         End If
Seguir:
