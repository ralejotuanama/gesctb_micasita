...
Begin VB.Form frm_Pro_CtbIntCof_02 
   ...
   Begin Threed.SSPanel SSPanel6 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   50
         Picture         =   "GesCtb_frm_917.frx":000C
         Top             =   120
         Width           =   480
      End
   End
   ...
   Begin Threed.SSPanel SSPanel10 
      ...
      Begin VB.CommandButton cmd_Salida 
         Height          =   585
         Left            =   8370
         Picture         =   "GesCtb_frm_917.frx":0316
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Salir"
         Top             =   30
      ...
      Begin VB.CommandButton cmd_ExpExc 
         Height          =   585
         Left            =   45
         Picture         =   "GesCtb_frm_917.frx":0758
         Style           =   1  'Graphical
         TabIndex        =   11
   ...
   End
End
Attribute VB_Name = "frm_Pro_CtbIntCof_02"
...
Dim r_int_NumFil        As Integer
   ...
   With r_obj_Excel.ActiveSheet
      .Cells(2, 2) = "CONTABILIZACION DEL INTERES POR PAGAR A COFIDE: " & Trim(pnl_periodo.Caption)
...
Dim r_str_produc     As String
   ...
   Select Case r_str_Codigo
      Case "003": r_str_produc = "CME"
                  r_str_CtaD = "411402020102"
      Case "004": r_str_produc = "MIHOGAR"
                  r_str_CtaD = "411402020101"
      Case Else: r_str_produc = "MIVIVIENDA"
   ...
   grd_Listad.Col = 0: grd_Listad.Text = "GASTO INTERES COFIDE - " & r_str_produc
   grd_Listad.Col = 1: grd_Listad.Text = r_str_CtaD
   grd_Listad.Col = 2: grd_Listad.Text = Format(moddat_g_dbl_IngDec, "###,###,##0.00")
   ...
   grd_Listad.Col = 3: grd_Listad.Text = Format(moddat_g_dbl_IngDec, "###,###,##0.00")
