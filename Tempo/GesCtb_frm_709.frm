...
Begin VB.Form frm_RepSbs_16 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel2 
            ...
            _ExtentY        =   476
            _StockProps     =   15
            Caption         =   "F0116-01 Cuadro de Liquidez de Plazos de Vencimiento"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesCtb_frm_709.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Proces 
            Height          =   585
            Left            =   30
            Picture         =   "GesCtb_frm_709.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   15
         ...
         Begin VB.CommandButton cmd_ExpArc 
            Height          =   585
            Left            =   1830
            Picture         =   "GesCtb_frm_709.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   1230
            Picture         =   "GesCtb_frm_709.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   630
            Picture         =   "GesCtb_frm_709.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Imprimir Reporte"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   4980
            Picture         =   "GesCtb_frm_709.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_ExpDet 
            Height          =   585
            Left            =   2430
            Picture         =   "GesCtb_frm_709.frx":14B8
            Style           =   1  'Graphical
            TabIndex        =   5
            ToolTipText     =   "Imprimir Reporte"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_RepSbs_16"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
   Dim r_dbl_Evalua(700)   As Double
...
Private Sub cmd_ExpExc_Click()
   ...
   r_int_Cantid = modsec_gf_CanReg("HIS_CULIPL", CInt(ipp_PerAno.Text), CInt(cmb_PerMes.ItemData(cmb_PerMes.ListIndex)))
...
Private Sub fs_Genera_ArcPla()
   ...
   r_str_NomRes = "C:\01" & Right(r_int_PerAno, 2) & Format(r_int_PerMes, "00") & Format(modsec_gf_Fin_Del_Mes(r_str_FecRpt), "dd") & ".116"
   ...
   Print #r_int_NumRes, Format(116, "0000") & Format(1, "00") & Format(r_int_CodEmp, "00000") & r_int_PerAno & Format(r_int_PerMes, "00") & Format(modsec_gf_Fin_Del_Mes(r_str_FecRpt), "dd") & Format(12, "000")
   
   r_int_ConAux = 0
   
   
   For r_int_Contad = 100 To 2900 Step 100
      r_str_Cadena = ""
      
      If r_int_Contad <> 100 And r_int_Contad <> 1000 Then
         For r_int_ConTem = 0 To 13 Step 1
...
Private Sub fs_GenExc()
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Range(.Cells(3, 14), .Cells(5, 14)).HorizontalAlignment = xlHAlignRight
      .Cells(3, 14) = "Anexo Nº 16"
      .Cells(5, 14) = "CODIGO S.B.S.: 240"
      .Range(.Cells(3, 14), .Cells(3, 15)).Merge
      .Range(.Cells(5, 14), .Cells(5, 15)).Merge
      ...
      .Range(.Cells(6, 1), .Cells(6, 16)).Merge
      .Range(.Cells(7, 1), .Cells(7, 16)).Merge
      .Range(.Cells(8, 1), .Cells(8, 16)).Merge
      
      '.Range(.Cells(6, 8), .Cells(8, 1)).Font.Underline = xlUnderlineStyleSingle
      .Cells(6, 1) = "CUADRO DE LIQUIDEZ POR PLAZO DE VENCIMIENTO 1/"
      ...
      .Cells(15, 11) = "M.N."
      .Cells(15, 12) = "M.E."
      .Cells(13, 13) = "MAS DE 6 MESES HASTA 12 MESES"
      .Cells(15, 13) = "M.N."
      .Cells(15, 14) = "M.E."
      .Cells(13, 15) = "MAS DE 12 MESES"
      .Cells(15, 15) = "M.N."
      .Cells(15, 16) = "M.E."
      ...
      .Cells(44, 2) = "Indicadores"
      .Cells(45, 2) = "Deuda con 10 Mayores Acreedores/Total Acreedores 12/"
      .Cells(46, 2) = "Deuda con 10 Mayores Depositantes/Total Depósitos"
      .Cells(47, 2) = "Deuda con 20 Principales Depositantes/Total Depósitos"
      .Cells(48, 2) = "Depósitos del Sector Público/Total Depósitos"
      .Cells(50, 2) = "Préstamos, Contingentes y Operaciones de Arrendamiento Financiero a Plazo Mayor de 1 Año/Patrimonio Efectivo(IV) 13/"
      '.Cells(53, 2) = "Financiero a Plazo Mayor de 1 Año/Patrimonio Efectivo(IV) 13/"
      .Cells(51, 2) = "Depósitos y Bonos a Más de 18 Meses/Patrimonio Efectivo(VII) 14/"
      '.Cells(55, 2) = "EFECTIVO (VII) 14/"
      .Cells(52, 2) = "BRECHA DE MEDIANO PLAZO (VI-VII)"
      
      .Columns("A").ColumnWidth = 24
      .Columns("A").NumberFormat = "@"
            
      .Columns("B").ColumnWidth = 74
      ...
      .Range(.Cells(13, 15), .Cells(14, 16)).WrapText = True
      ...
      .Range(.Cells(25, 1), .Cells(25, 16)).Font.Bold = True
      .Range(.Cells(25, 1), .Cells(25, 16)).Borders(xlEdgeTop).LineStyle = xlContinuous
      .Range(.Cells(25, 1), .Cells(25, 16)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      .Range(.Cells(25, 1), .Cells(25, 16)).VerticalAlignment = xlCenter
            
      .Range(.Cells(26, 1), .Cells(26, 16)).Font.Bold = True
      .Range(.Cells(26, 1), .Cells(26, 16)).Borders(xlEdgeTop).LineStyle = xlContinuous
      .Range(.Cells(26, 1), .Cells(26, 16)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      .Range(.Cells(26, 1), .Cells(26, 16)).VerticalAlignment = xlCenter
      .Range(.Cells(26, 1), .Cells(26, 16)).HorizontalAlignment = xlHAlignCenter
            
      Dim r_int_Contad As Integer
      
      For r_int_Contad = 1 To 16 Step 1
      ...
      For r_int_Contad = 39 To 42 Step 1
         .Range(.Cells(r_int_Contad, 1), .Cells(r_int_Contad, 16)).Font.Bold = True
         .Range(.Cells(r_int_Contad, 1), .Cells(r_int_Contad, 16)).Borders(xlEdgeTop).LineStyle = xlContinuous
         .Range(.Cells(r_int_Contad, 1), .Cells(r_int_Contad, 16)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      Next
      
      .Range(.Cells(13, 1), .Cells(15, 16)).Font.Bold = True
      .Range(.Cells(13, 1), .Cells(15, 16)).VerticalAlignment = xlCenter
      .Range(.Cells(13, 1), .Cells(15, 16)).HorizontalAlignment = xlHAlignCenter
      '.Range(.Cells(13, 1), .Cells(15, 16)).Interior.Color = RGB(146, 208, 80)
      .Range(.Cells(13, 1), .Cells(15, 16)).Borders(xlEdgeLeft).LineStyle = xlContinuous
      .Range(.Cells(13, 1), .Cells(15, 16)).Borders(xlEdgeTop).LineStyle = xlContinuous
      .Range(.Cells(13, 1), .Cells(15, 16)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      .Range(.Cells(13, 1), .Cells(15, 16)).Borders(xlEdgeRight).LineStyle = xlContinuous
      .Range(.Cells(13, 1), .Cells(15, 16)).Borders(xlInsideVertical).LineStyle = xlContinuous
      
      For r_int_Contad = 2 To 3 Step 1
         .Range(.Cells(44, 2), .Cells(48, r_int_Contad)).Borders(xlEdgeLeft).LineStyle = xlContinuous
         .Range(.Cells(44, 2), .Cells(48, r_int_Contad)).Borders(xlEdgeTop).LineStyle = xlContinuous
         .Range(.Cells(44, 2), .Cells(48, r_int_Contad)).Borders(xlEdgeBottom).LineStyle = xlContinuous
         .Range(.Cells(44, 2), .Cells(48, r_int_Contad)).Borders(xlEdgeRight).LineStyle = xlContinuous
         .Range(.Cells(44, 2), .Cells(48, r_int_Contad)).Borders(xlInsideVertical).LineStyle = xlContinuous
      Next
      
      For r_int_Contad = 44 To 48 Step 1
         '.Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 5)).Font.Bold = True
         .Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 3)).Borders(xlEdgeTop).LineStyle = xlContinuous
         .Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 3)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      Next
      
      For r_int_Contad = 2 To 3 Step 1
         .Range(.Cells(50, 2), .Cells(52, r_int_Contad)).Borders(xlEdgeLeft).LineStyle = xlContinuous
         .Range(.Cells(50, 2), .Cells(52, r_int_Contad)).Borders(xlEdgeTop).LineStyle = xlContinuous
         .Range(.Cells(50, 2), .Cells(52, r_int_Contad)).Borders(xlEdgeBottom).LineStyle = xlContinuous
         .Range(.Cells(50, 2), .Cells(52, r_int_Contad)).Borders(xlEdgeRight).LineStyle = xlContinuous
         .Range(.Cells(50, 2), .Cells(52, r_int_Contad)).Borders(xlInsideVertical).LineStyle = xlContinuous
      Next
      
      For r_int_Contad = 50 To 52 Step 1
         '.Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 5)).Font.Bold = True
         .Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 3)).Borders(xlEdgeTop).LineStyle = xlContinuous
         .Range(.Cells(r_int_Contad, 2), .Cells(r_int_Contad, 3)).Borders(xlEdgeBottom).LineStyle = xlContinuous
      Next
   ...
   For r_int_ConAux = 17 To 52 Step 1
      If r_int_ConAux <> 26 And r_int_ConAux <> 43 And r_int_ConAux <> 44 And r_int_ConAux <> 49 Then
         If r_int_ConAux < 45 Then
            For r_int_Contad = 3 To 16 Step 1
               r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad) = r_dbl_Evalua(r_int_ConTem)
               r_int_ConTem = r_int_ConTem + 1
            Next
         Else
            r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, 3) = r_dbl_Evalua(r_int_ConTem)
            r_int_ConTem = r_int_ConTem + 14
...
Private Sub fs_GeneDB_Exc()
   ...
   g_str_Parame = "DELETE FROM HIS_CULIPL WHERE "
   g_str_Parame = g_str_Parame & "CULIPL_PERMES = " & r_int_PerMes & " AND "
   g_str_Parame = g_str_Parame & "CULIPL_PERANO = " & r_int_PerAno & " "
   ...
   For r_int_Contad = 0 To 31 Step 1
      ...
      For r_int_ConAux = 0 To 13 Step 1
      ...
      If Not gf_EjecutaSQL(r_str_Cadena, g_rst_Princi, 2) Then
         MsgBox "Error al ejecutar el Procedimiento USP_HIS_CULIPL.", vbCritical, modgen_g_str_NomPlt
         Exit Sub
      End If
...
Private Sub fs_GenDat_Exc()
   ...
   r_str_Denomi(51) = "Deuda con 10 Mayores Acreedores/Total Acreedores "
   r_str_Denomi(53) = "Deuda con 10 Mayores Depositantes/Total Depósitos"
   r_str_Denomi(55) = "Deuda con 20 Principales Depositantes/Total Depósitos"
   r_str_Denomi(57) = "Depósitos del Sector Público/Total Depósitos"
   r_str_Denomi(59) = "Préstamos, Contingentes y Operaciones de Arrendamiento Financiero a Plazo Mayor de 1 Año/Patrimonio Efectivo(IV) "
   r_str_Denomi(61) = "Depósitos y Bonos a Más de 18 Meses/Patrimonio Efectivo(VII) "
   r_str_Denomi(63) = "BRECHA DE MEDIANO PLAZO (VI-VII)"
...
Private Sub fs_GenDat_DB()
   ...
   g_str_Parame = "SELECT * FROM HIS_CULIPL WHERE "
   g_str_Parame = g_str_Parame & "CULIPL_PERMES = " & r_int_PerMes & " AND "
   g_str_Parame = g_str_Parame & "CULIPL_PERANO = " & r_int_PerAno & " "
   g_str_Parame = g_str_Parame & "ORDER BY CULIPL_NUMITE ASC "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         r_dbl_Evalua(r_int_ConAux + 1) = g_rst_Princi!CULIPL_TOTAMN
         r_dbl_Evalua(r_int_ConAux + 2) = g_rst_Princi!CULIPL_TOTAME
         r_dbl_Evalua(r_int_ConAux + 3) = g_rst_Princi!CULIPL_1MESMN
         r_dbl_Evalua(r_int_ConAux + 4) = g_rst_Princi!CULIPL_1MESME
         r_dbl_Evalua(r_int_ConAux + 5) = g_rst_Princi!CULIPL_2MESMN
         r_dbl_Evalua(r_int_ConAux + 6) = g_rst_Princi!CULIPL_2MESME
         r_dbl_Evalua(r_int_ConAux + 7) = g_rst_Princi!CULIPL_3MESMN
         r_dbl_Evalua(r_int_ConAux + 8) = g_rst_Princi!CULIPL_3MESME
         r_dbl_Evalua(r_int_ConAux + 9) = g_rst_Princi!CULIPL_6MESMN
         r_dbl_Evalua(r_int_ConAux + 10) = g_rst_Princi!CULIPL_6MESME
         r_dbl_Evalua(r_int_ConAux + 11) = g_rst_Princi!CULIPL_12MSMN
         r_dbl_Evalua(r_int_ConAux + 12) = g_rst_Princi!CULIPL_12MSME
         r_dbl_Evalua(r_int_ConAux + 13) = g_rst_Princi!CULIPL_MAMEMN
         r_dbl_Evalua(r_int_ConAux + 14) = g_rst_Princi!CULIPL_MAMEME
         
         r_int_ConAux = r_int_ConAux + 14
...
Private Sub fs_GeneDB()
   ...
   For r_int_Contad = 1 To 7 Step 1

      r_str_Cadena = "USP_RPT_ANEXOS ("
      r_str_Cadena = r_str_Cadena & 0 & ", "
      r_str_Cadena = r_str_Cadena & 0 & ", "
      r_str_Cadena = r_str_Cadena & "'" & modgen_g_str_NombPC & "', "
      r_str_Cadena = r_str_Cadena & "'" & modgen_g_str_CodUsu & "', "
      r_str_Cadena = r_str_Cadena & CInt(r_int_PerMes) & ", "
      r_str_Cadena = r_str_Cadena & CInt(r_int_PerAno) & ", "
      r_str_Cadena = r_str_Cadena & CInt(IIf(r_int_Contad < 5, r_int_Contad, IIf(r_int_Contad < 7, r_int_Contad + 1, r_int_Contad + 3))) & ", "
      r_str_Cadena = r_str_Cadena & (r_dbl_TipCam) & ", "
      
      For r_int_ConAux = 0 To 14 Step 1
         r_str_Cadena = r_str_Cadena & r_dbl_Evalua(r_int_ConTem) & ", "
         r_int_ConTem = r_int_ConTem + 1
      Next
      ...
      If Not gf_EjecutaSQL(r_str_Cadena, g_rst_Princi, 2) Then
         MsgBox "Error al ejecutar el Procedimiento USP_RPT_ANEXOS.", vbCritical, modgen_g_str_NomPlt
         Exit Sub
      End If
...
Private Sub fs_GenDat()
   ...
   g_str_Parame = g_str_Parame & "HIPCUO_FECVCT <= " & GenFec(CDate(r_str_Fechas(0)) - 1) & " "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         ElseIf Trim(g_rst_Princi!HIPMAE_CODPRD) = "010" Then
            r_dbl_Evalua(90) = r_dbl_Evalua(90) + g_rst_Princi!CAPITAL
   ...
   For r_int_Contad = 0 To 26 Step 2
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         Do While Not g_rst_Princi.EOF
            ...
            ElseIf Trim(g_rst_Princi!HIPMAE_CODPRD) = "010" Then
               r_dbl_Evalua((r_int_Contad / 2) + 91) = r_dbl_Evalua((r_int_Contad / 2) + 91) + g_rst_Princi!CAPITAL
   ...
   g_str_Parame = g_str_Parame & "HIPCUO_FECVCT <= " & GenFec(CDate(r_str_Fechas(0)) - 1) & " AND "
   ...
   For r_int_Contad = 0 To 26 Step 2
      ...
      If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
         ...
         Do While Not g_rst_Princi.EOF
            ...
            If Trim(g_rst_Princi!HIPMAE_CODPRD) = "004" Then
               r_dbl_Evalua((r_int_Contad / 2) + 46) = r_dbl_Evalua((r_int_Contad / 2) + 46) + g_rst_Princi!CAPITAL
